...
cm    TOOLSRC     CO_P         CLLE    "Compile Object - Cmd Processor"
...
cm    TOOLSRC     RDI_CO       CMD     "RDi: Compile Object"
cm    TOOLSRC     RDI_CO_P     CLP     "RDi: Compile Object - Cmd Processor"
...
cm    QINCSRC     PGM_HEAD     RPGLE   "Program Header specs (ACTGRP *NEW)"
...
cm    QDDSSRC     CAFNWD       DSPF    "CAF - Non-Work Days"
cm    QDDSSRC     CAFNWDT      DSPF    "CAF - Non-Work Day Types"
...
cm    QRPGLESRC   CAFNWD       RPGLE   "CAF - Non-Work Days"
cm    QRPGLESRC   CAFNWDT      RPGLE   "CAF - Non-Work Day Types"
cm    QRPGLESRC   CAFSQLS      RPGLE   "CAF - SQL Statements: Work with"
cm    QRPGLESRC   CAFSQLSD     RPGLE   "CAF - SQL Statements: Detail"
cm    QCLLESRC    CAFMENUGP    CLLE    "CAFMENUG Cmd Processor"
cm    QCLLESRC    CAFMENUP     CLLE    "CAFMENU Cmd Processor"
cm    QCLLESRC    CAFNWDP      CLLE    "CAFNWD Cmd Processor"
cm    QCLLESRC    CAFNWDTP     CLLE    "CAFNWDT Cmd Processor"
cm    QCLLESRC    CAFSQLSP     CLLE    "CAFSQLS Cmd Processor"
cm    QCMDSRC     CAFMENU      CMD     "CAF - Menu"
cm    QCMDSRC     CAFMENUG     CMD     "CAF - Menu Groups: Work with"
cm    QCMDSRC     CAFNWD       CMD     "CAF - Non-Work Days"
cm    QCMDSRC     CAFNWDT      CMD     "CAF - Non-Work Day Types"
...
cm    CSYSBASES   INCL__MODD   RPGLE   "CSYSBASE/Include: Module Declarations"
...
cm    CSYSBASES   INCL_DECL    RPGLE   "CSYSBASE/Include: Declarations"
...
cm    CSYSSQLSS   INCL__MODD   RPGLE   "CSYSSQLS/Include: Module Declarations"
...
cm    CSYSSQLSS   INCL_DECL    RPGLE   "CSYSSQLS/Include: Declarations"
...
cm    CAPPBASES   INCL__MODD   RPGLE   "CAPPBASE/Include: Module Declarations"
...
cm    CAPPBASES   INCL_DECL    RPGLE   "CAPPBASE/Include: Declarations"
...
cm    CAPPSSAMS   INCL__MODD   RPGLE   "CAPPSSAM/Include: Module Declarations"
...
cm    CAPPSSAMS   INCL_DECL    RPGLE   "CAPPSSAM/Include: Declarations"
...
cm    CAPPDISPS   INCL__MODD   RPGLE   "CAPPDISP/Include: Module Declarations"
...
cm    CAPPDISPS   INCL_DECL    RPGLE   "CAPPDISP/Include: Declarations"
